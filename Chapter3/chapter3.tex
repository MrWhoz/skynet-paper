...
Giá trị Ro được xác định trong môi trường không khí sạch, như Hình \ref{fig:mq07_mqh1} ta thấy được giá trị Rs/Ro luôn là 100 (hằng số không đổi) trong môi trường không khí sạch. Như vậy cần xác định Ro bằng cách để cảm biến MQ07 chạy trong môi trường không khí sạch và tính giá trị $R_{S}=\frac{V_{C}}{V_{RL}}R_{L}$ trung bình trong 100 lần đo. Từ đó chúng ta sẽ có Ro trong không khí sạch $R_{O} = \frac{R_{S}}{100}$.
